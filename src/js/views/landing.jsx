...
import { ContactContext } from "../context/Contact.jsx";
            ...
            <ul className="list-group list-group-flush border rounded">
                {contactList.map((contact, index) => {
                    ...
                    <div className="d-flex mb-3 gap-3">
                        <img src={`https://picsum.photos/id/12${index}/200/300`} className="userImage mt-3"></img>
                        <div className="d-flex row">
                            <p className="fs-4">{contact.name}</p>
                            <p className="text-secondary fw-semibold"><i className="fas fa-map-marker-alt text-danger"></i> {contact.address}</p>
                            <p className="text-secondary"><i className="fas fa-phone"></i> {contact.phone}</p>
                            <p className="text-secondary"><i className="fas fa-envelope"></i> {contact.email}</p>
                        </div>
